...
clearplotlabels
SaveAsPngEpsAndFig(-1,'Figures/Examples/04', 6, 7/5, 14);
steadystateshape(data_path,1,1)
clearplotlabels
SaveAsPngEpsAndFig(-1,'Figures/Examples/07', 6, 7/5, 14);

data_path = get_data_path(2, 0.7);
steadystateshape(data_path,0,1)
clearplotlabels
SaveAsPngEpsAndFig(-1,'Figures/Examples/05', 6, 7/5, 14);
steadystateshape(data_path,1,1)
clearplotlabels
SaveAsPngEpsAndFig(-1,'Figures/Examples/08', 6, 7/5, 14);

data_path = get_data_path(2, 0.9);
steadystateshape(data_path,0,1)
clearplotlabels
SaveAsPngEpsAndFig(-1,'Figures/Examples/06', 6, 7/5, 14);
steadystateshape(data_path,1,1)
clearplotlabels
SaveAsPngEpsAndFig(-1,'Figures/Examples/09', 6, 7/5, 14);
