...
anim = 0;  % Disable animations for batch reader
total_jobs = 3;
...
addpath(genpath('/tmp/blake/home/Workspace/Chaste//TestUtericBudSimulation/results_from_time_0/'));
populationdata = LoadNonConstantLengthData('celltypes.dat');
