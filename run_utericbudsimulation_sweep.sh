...
do
	...
	nice -20 /home/blake/Workspace/Chaste/projects/BlakeC/build/optimised/UtericBudSimulation/UtericBudSimulation_Sweeper3Runner -sim_time 100 -parameter ${PARAMETER[$i]} > output/SimulationRun_${PARAMETER[$i]}_Output.txt 2>&1 &
