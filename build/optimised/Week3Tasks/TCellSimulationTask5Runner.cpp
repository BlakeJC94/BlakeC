...
#include "projects/BlakeC/test/Week3Tasks/TCellSimulationTask5.hpp"

static TCellSimulation suite_TCellSimulation;

static CxxTest::List Tests_TCellSimulation = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_TCellSimulation( "projects/BlakeC/test/Week3Tasks/TCellSimulationTask5.hpp", 70, "TCellSimulation", suite_TCellSimulation, Tests_TCellSimulation );
