...
#include "projects/BlakeC/test/NodeBasedTumorSimulationTask.hpp"

static NodeBasedTumorSimulation suite_NodeBasedTumorSimulation;

static CxxTest::List Tests_NodeBasedTumorSimulation = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_NodeBasedTumorSimulation( "projects/BlakeC/test/NodeBasedTumorSimulationTask.hpp", 66, "NodeBasedTumorSimulation", suite_NodeBasedTumorSimulation, Tests_NodeBasedTumorSimulation );
