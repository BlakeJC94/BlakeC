...
#include "projects/BlakeC/test/Mscv1/MscV1.hpp"

static TCellSimulation suite_TCellSimulation;

static CxxTest::List Tests_TCellSimulation = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_TCellSimulation( "projects/BlakeC/test/Mscv1/MscV1.hpp", 83, "TCellSimulation", suite_TCellSimulation, Tests_TCellSimulation );
