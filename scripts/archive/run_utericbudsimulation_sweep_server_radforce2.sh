...
echo " RADFORCE2 " ${gforce_strength};
	
nice -20 /data/blakec/workspace/Chaste/projects/BlakeC/build/optimised/UtericBudSimulation/UtericBudSimulation_SweeperRadForce2Runner \
-sim_time $sim_time \
-num_sims $num_sims \
...
> output/SimulationRun_RadForce2_Output.txt 2>&1 &
