...
do
	...
	nice -20 /home/blake/Workspace/Chaste/projects/BlakeC/build/optimised/UtericBudSimulation/UtericBudSimulationRunner -sim_index $i -sim_time 200 > output/SimulationRun_${i}_Output.txt 2>&1 &
