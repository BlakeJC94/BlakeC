 ...
 * cells divide a certain number of generations before becoming differentiated. To implement this model we define a new cell-cycle model, {{{GroupACellCycleModel}}},
 ...
 */
class GroupACellCycleModel : public AbstractSimpleCellCycleModel
{
...
public:
     ...
     * {{{GroupACellCycleModel}}} inherits from its base class, we will find that some of
    ...
    {
        GroupACellCycleModel* p_model = new GroupACellCycleModel();
...
CHASTE_CLASS_EXPORT(GroupACellCycleModel);
