...
do
    ...
    do
    	...
    	nice -20 /home/blake/Workspace/Chaste/projects/BlakeC/build/optimised/UtericBudSimulation/UtericBudSimulation_ConcBSweeperRunner -sim_index $i -sim_time $sim_time -parameter ${PARAMETER[$j]} > output/SimulationRun_${PARAMETER[$j]}_${i}_Output.txt 2>&1 &
    done
done
